...
function ItemDetail(props) {
    ...
    return (
        <div className='card md:ml-20 my-5   md:flex'>
            <div className="w-full max-w-sm bg-white   dark:bg-black dark:border-gray-700">
                ...
                <div className="px-5 pb-5 text-center">
                    ...
                    <div className="flex-col  items-center ml-24">
                        <div className="flex items-center mt-2.5 mb-5">
                            <span className="bg-red-100 text-red-800 text-s font-semibold mt-5 mr-2 px-2.5 py-0.5 rounded dark:bg-red-200 dark:text-red-800 ml-3">Calificación: {props.calificacion}</span>
                        </div>
                    ...
                    <span className="text-white font-bold"> Precio: ${props.valor} ARS</span>
            ...
            <NavLink to={`/cart`} > <button type="button" className="animate-pulse inline-flex relative items-center h-1 text-sm 
                font-medium text-center text-white  rounded-lg  focus:ring-4 focus:outline-none focus:ring-red-300 ">
      <img className="h-14 mx-4 cursor-pointer" src={CartIcon}></img> </button> </NavLink>
</div> }
                </div>
            </div>
            <div className="w-full   max-w-sm pt-3 bg-white dark:bg-black dark:border-gray-700">
